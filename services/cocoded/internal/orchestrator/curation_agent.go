...
func normalizeCuratorCategory(category string) string {
	...
	case "tests", "test":
		return "testing"
	case "api_compatibility", "api_compat":
		return "api"
	case "data", "data_integrity_transactions":
