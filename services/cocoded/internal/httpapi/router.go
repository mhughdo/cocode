...
func NewRouter(config app.Config, logger *slog.Logger, database *sql.DB) http.Handler {
	...
	api.POST("/workspaces/:id/settings-import", importWorkspaceSettingsHandler(services))
	api.PATCH("/review-rules/:id", updateReviewRuleHandler(queries))
	api.PATCH("/review-rules/:id/enabled", setReviewRuleEnabledHandler(queries))
	api.DELETE("/review-rules/:id", deleteReviewRuleHandler(queries))
	...
	api.POST("/review-sessions/:id/findings/:finding_id/evidence-map/question", askEvidenceMapQuestionHandler(services))
	...
	api.POST("/findings/:finding_id/evidence-map/question", askEvidenceMapQuestionHandler(services))
